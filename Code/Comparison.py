...
if __name__ == '__main__':
    ...
    def cn(top=3):
        dd = r'C:/Users/lpy20/Desktop/UCLA/ML in Chem/optimization data logs/optimization data logs/chemistry data simulation logs/CN coupling (Doyle_Merck)/'
        num_sims = 500
        num_round = 100
        num_exp = 1
        fn_list = [f'{dd}{n}/log.csv' for n in
        ...
        plot_accuracy_best_arm(best_arm_indexes=indexes,
                               ...
                               vlines=[36, 72],
                               calc_random_exploration=False,
                               ylabel='Accuracy of identifying top-{top} conditions')

    def aryl(top=5):
        dd = 'C:/Users/lpy20/Desktop/UCLA/ML in Chem/optimization data logs/optimization data logs/chemistry data simulation logs/arylation/full scope simulation/'
        num_sims = 500
        num_round = 200
        num_exp = 1
        fn_list = [f'{dd}{n}/log.csv' for n in
                   [f'ts_gaussian_squared-{num_sims}s-{num_round}r-{num_exp}e',
                    ...
                    f'bayes_ucb_gaussian_ppf_squared_c=2-{num_sims}s-{num_round}r-{num_exp}e',
                    f'bayes_ucb_gaussian_ppf_c=2_assumed_sd=0.25-{num_sims}s-200r-{num_exp}e',
                    f'eps_greedy_annealing-{num_sims}s-{num_round}r-{num_exp}e',
                    f'random-{num_sims}s-{num_round}r-{num_exp}e'
                    ]]
        legend_list = ['TS (squared)',
                       ...
                       'Bayes ucb (2SD, squared)',
                       'Bayes ucb (2SD, 0.25)',
                       'Bayes ucb PPF (2SD, squared)',
                       'Bayes ucb PPF (2SD, 0.25)',
                       'ε-greedy',
                       'Random pick'
                       ]
        #f'bayes_ucb_gaussian_c=2_assumed_sd=0.25-{num_sims}s-{num_round}r-{num_exp}e',
        ...
        plot_accuracy_best_arm(best_arm_indexes=indexes,
                               ...
                               ignore_first_rounds=0,
                               ylabel=f'Accuracy of identifying top {top} optimal ligands',
                               legend_title='algorithm',
                               long_legend=True,
    ...
    def amidation(top=3, combo=False):
        if combo:
            dd = 'C:/Users/lpy20/Desktop/UCLA/ML in Chem/optimization data logs/optimization data logs/chemistry data simulation logs/amide coupling/activator-base/'
            shade_n = 32
            what = 'activator/base'  # for title of the plot
        else:
            dd = 'C:/Users/lpy20/Desktop/UCLA/ML in Chem/optimization data logs/optimization data logs/chemistry data simulation logs/amide coupling/activator/'
            shade_n = 8
            what = 'activator'
        num_sims = 500
        num_round = 96
        ...
        fn_list = [f'{dd}{n}/log.csv' for n in
                   [f'ts_gaussian_squared-{num_sims}s-{num_round}r-{num_exp}e',
                    ...
                    f'bayes_ucb_gaussian_c=2_assumed_sd=0.25-{num_sims}s-{num_round}r-{num_exp}e',
                    f'bayes_ucb_gaussian_ppf_squared_c=2-{num_sims}s-{num_round}r-{num_exp}e',
                    f'bayes_ucb_gaussian_ppf_c=2_assumed_sd=0.25-{num_sims}s-{num_round}r-{num_exp}e',
                    f'eps_greedy_annealing-{num_sims}s-{num_round}r-{num_exp}e',
                    f'random-{num_sims}s-{num_round}r-{num_exp}e'
                    ]]
        legend_list = ['TS (squared)',
        ...
        plot_accuracy_best_arm(best_arm_indexes=indexes,
                               ...
                               ignore_first_rounds=0,
                               ylabel=f'Accuracy of identifying top {top} {what}',
                               legend_title='Algorithm',
                               long_legend=True,
                               calc_random_exploration=True)
